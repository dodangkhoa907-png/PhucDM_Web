    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (response instanceof HttpServletResponse res) {
            ...
            res.setHeader("Content-Security-Policy",
                    "default-src 'self'; "
                    // cdn.tailwindcss.com + unpkg.com: landing page trang chủ dùng Tailwind Play CDN
                    // và Lucide icons. Play CDN biên dịch class lúc chạy — tiện cho giai đoạn dựng
                    // giao diện, nhưng khi lên production nên build Tailwind ra file .css tĩnh rồi
                    // gỡ 2 domain này khỏi CSP cho gọn và nhanh hơn.
