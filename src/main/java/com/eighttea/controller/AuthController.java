...
import com.eighttea.service.UserService;
import com.eighttea.service.impl.UserServiceImpl;
...
public class AuthController extends HttpServlet {
    ...
    /**
     * Đăng xuất thật — chỉ qua POST (đã được {@link com.eighttea.filter.CsrfFilter} kiểm tra
     * token "_csrf" trước khi vào đây). Invalidate toàn bộ session ("user", giỏ hàng, CSRF token
     * cũ...) rồi redirect về trang chủ. Admin dùng cookie riêng (xem {@link com.eighttea.util.AdminAuth})
