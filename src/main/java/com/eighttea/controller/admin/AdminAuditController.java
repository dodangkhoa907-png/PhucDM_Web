...
import com.eighttea.model.AuditLogFilter;
 ...
 * duy nhất là {@link com.eighttea.util.AuditLogger} gọi rải rác khắp codebase — controller
 * này không đụng tới đường ghi đó.
 *
 * Quyền hạn: nằm dưới urlPattern "/admin/*" nên đã được {@link com.eighttea.filter.AuthFilter}
 * chặn — chỉ Staff đã đăng nhập (cookie {@link com.eighttea.util.AdminAuth}) mới tới được. Chỉ nhận GET nên
 * {@link com.eighttea.filter.CsrfFilter} (chỉ kiểm tra POST/PUT/DELETE) không áp dụng ở đây.
 */
