package com.eighttea.controller.admin;

import com.eighttea.dao.AuditLogDao;
import com.eighttea.dao.OrderDAO;
import com.eighttea.dao.StaffDao;
import com.eighttea.dao.impl.AuditLogDaoImpl;
import com.eighttea.dao.impl.OrderDaoImpl;
import com.eighttea.dao.impl.StaffDaoImpl;
import com.eighttea.model.Order;
import com.eighttea.model.OrderAdminFilter;
import com.eighttea.model.OrderTabCounts;
import com.eighttea.model.Staff;
import com.eighttea.util.AdminAuth;
import com.eighttea.util.AuditLogger;
import com.eighttea.util.OrderStatuses;
import com.eighttea.util.PaymentStatuses;
import com.eighttea.util.StaffRoles;
 ...
 *
 * Quyền hạn: nằm dưới urlPattern "/admin/*" nên đã được {@link com.eighttea.filter.AuthFilter}
 * chặn — chỉ Staff đã đăng nhập (cookie {@link com.eighttea.util.AdminAuth}) mới tới được. Mọi POST đã được
 * {@link com.eighttea.filter.CsrfFilter} kiểm tra token "_csrf" trước khi vào servlet này.
