...
public interface OrderDAO {
    ...
    List<com.eighttea.model.OrderDetail> findDetailsByOrderIdAndUserId(int orderId, int userId);
    ...
    /** Cập nhật trạng thái đơn có kiểm tra transition hợp lệ qua {@link com.eighttea.util.OrderStatuses#canTransition}. */
