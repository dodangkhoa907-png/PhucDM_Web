...
public interface ProductDao {
     ...
     * @param sort whitelist — xem {@link com.eighttea.util.ProductSort}
     */
    List<Product> findActiveForShop(Integer categoryId, String keyword, com.eighttea.util.ProductSort sort);
