...
<style>
:root{--green:#BC5A24;--green-dark:#8F3F14;--gold:#D9A066;--gold-light:#F0CFA4;--coral:#E07A5F;--cream:#FAF6F0;--paper:#FFFFFF;--ink:#241C17;--ink-soft:#9A8878;--line:#E7DCCE;--fd:'Bricolage Grotesque',sans-serif;--fb:'Hanken Grotesk','Be Vietnam Pro',sans-serif}
