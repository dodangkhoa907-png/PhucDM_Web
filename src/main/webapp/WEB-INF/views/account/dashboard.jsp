...
<head>
    ...
    <title>Tài Khoản Của Tôi — Eight Tea</title>
    ...
    <section class="section" style="padding-top:130px;">
        <div class="container">
            ...
            <div class="account-page-header">
                ...
                <div class="account-page-subtitle">Tổng quan hoạt động mua sắm của bạn tại Eight Tea</div>
            </div>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div class="shop-empty" style="padding:40px 20px">
                                    ...
                                    <p>Khám phá thực đơn và đặt ly trà đầu tiên của bạn.</p>
