...
<head>
    ...
    <title>Đơn Hàng Của Tôi — Eight Tea</title>
...
<body class="shop-page-body">
    ...
    <section class="section" style="padding-top:130px;">
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/account" class="btn-go-back" style="margin-bottom:16px;">
                <span class="btn-go-back-icon"><i class="fa-solid fa-arrow-left"></i></span>
                Quay lại Tổng quan
            </a>
                                ...
                                <div class="shop-empty">
                                    ...
                                    <p>
                                        <c:choose>
                                            ...
                                            <c:otherwise>Bạn chưa đặt đơn hàng nào tại Eight Tea.</c:otherwise>
                                        </c:choose>
                                    </p>
