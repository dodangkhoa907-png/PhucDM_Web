...
<link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,500;12..96,700;12..96,800&family=Hanken+Grotesk:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
<style>
:root{--green:#BC5A24;--green-dark:#8F3F14;--green-light:#E07A5F;--gold:#D9A066;--gold-light:#F0CFA4;--coral:#E07A5F;--cream:#FAF6F0;--paper:#FFFFFF;--ink:#241C17;--ink-soft:#9A8878;--line:#E7DCCE;--fd:'Bricolage Grotesque',sans-serif;--fb:'Hanken Grotesk','Be Vietnam Pro',sans-serif}
...
<div class="auth">
  <div class="pane">
    <a href="${ctx}/" class="logo">Eight <b>Tea</b></a>
